...
var GuessCelebrityMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[{\"internalType\":\"address\",\"name\":\"recipient_\",\"type\":\"address\"},{\"components\":[{\"internalType\":\"uint256[2]\",\"name\":\"a\",\"type\":\"uint256[2]\"},{\"internalType\":\"uint256[2][2]\",\"name\":\"b\",\"type\":\"uint256[2][2]\"},{\"internalType\":\"uint256[2]\",\"name\":\"c\",\"type\":\"uint256[2]\"}],\"internalType\":\"structGroth16VerifierHelper.ProofPoints\",\"name\":\"zkPoints_\",\"type\":\"tuple\"}],\"name\":\"claimReward\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"}]",
}
...
func newGuessCelebrityCoder() (*abi.ABI, error) {
...
func (s *CallDataBuilder) BuildGuessCelebrityClaimRewardCalldata(
	recipient string,
	zkPointsJSON []byte,
) ([]byte, error) {
	recipientAddress := common.HexToAddress(recipient)

	_, proofPoints, err := prepareZKProofForEVMVerification(zkPointsJSON)
	if err != nil {
		return nil, fmt.Errorf("failed to prepare zk proof for evm verification: %v", err)
	}

	abi, err := newGuessCelebrityCoder()
	if err != nil {
		return nil, err
	}

	return abi.Pack("claimReward", recipientAddress, proofPoints)
}
